...
<?php $book = $db->getOne('WHERE book_id >= 9'); ?>
<hr>
<form method="post" action="php/dbupdateone.php">
	...
	<p><input type="hidden" name="book_id" value="<?= $book['book_id']; ?>"/><input type="submit" value="Update"/></p>
</form>
</body>
</html>